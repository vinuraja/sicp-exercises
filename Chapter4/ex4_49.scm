...
; The changes in grammar below allows us to generate sentences.
; To generate all n word sentences just use any random n word list.
; For example:
; (parse '(one two three))
; will generate all 3 word sentences
; (parse '(1 2 3 4 5 6))
; will generate all 6 word sentences.
